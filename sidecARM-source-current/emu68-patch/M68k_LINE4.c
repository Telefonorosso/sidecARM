...
extern volatile uint32_t linux_poc_cmd;
extern volatile uint32_t linux_poc_status;
extern volatile uint32_t linux_poc_data;
extern volatile uint32_t linux_poc_entry_off;
extern volatile uint32_t linux_poc_arg0_off;
    ...
    if (dr)
    {
        switch (opcode2 & 0xfff)
        {
            ...
            case 0x0ef: /* DBGADDRHI */
                ...
                RA_FreeARMRegister(ctx, tmp);
                break;
            case 0x1e4: /* ARM service entry offset */
#if defined(PISTORM_ANY_MODEL)
                tmp = RA_AllocARMRegister(ctx);
                u.u64 = (uintptr_t)&linux_poc_entry_off;
                EMIT(ctx,
                    mov64_immed_u16(tmp, u.u16[3], 0),
                    movk64_immed_u16(tmp, u.u16[2], 1),
                    movk64_immed_u16(tmp, u.u16[1], 2),
...
#endif
                break;
            case 0x1e5: /* ARM service arg0 offset */
#if defined(PISTORM_ANY_MODEL)
                tmp = RA_AllocARMRegister(ctx);
                u.u64 = (uintptr_t)&linux_poc_arg0_off;
                EMIT(ctx,
                    mov64_immed_u16(tmp, u.u16[3], 0),
                    movk64_immed_u16(tmp, u.u16[2], 1),
                    movk64_immed_u16(tmp, u.u16[1], 2),
...
#endif
                break;
            case 0x1e1: /* PiStorm CPU1 POC command */
#if defined(PISTORM_ANY_MODEL)
                tmp = RA_AllocARMRegister(ctx);
                u.u64 = (uintptr_t)&linux_poc_cmd;
                EMIT(ctx,
                    mov64_immed_u16(tmp, u.u16[3], 0),
                    movk64_immed_u16(tmp, u.u16[2], 1),
                    movk64_immed_u16(tmp, u.u16[1], 2),
...
#endif
                break;
            case 0x1e6: /* ARM service physical base */
#if defined(PISTORM_ANY_MODEL)
                tmp = RA_AllocARMRegister(ctx);
                u.u64 = (uintptr_t)&armservice_phys_base_68k;
                EMIT(ctx,
                    mov64_immed_u16(tmp, u.u16[3], 0),
                    movk64_immed_u16(tmp, u.u16[2], 1),
                    movk64_immed_u16(tmp, u.u16[1], 2),
...
#endif
                break;
            case 0x1e2: /* PiStorm CPU1 POC status */
#if defined(PISTORM_ANY_MODEL)
                tmp = RA_AllocARMRegister(ctx);
                u.u64 = (uintptr_t)&linux_poc_status;
                EMIT(ctx,
                    mov64_immed_u16(tmp, u.u16[3], 0),
                    movk64_immed_u16(tmp, u.u16[2], 1),
                    movk64_immed_u16(tmp, u.u16[1], 2),
...
#endif
                break;
            case 0x1e3: /* PiStorm CPU1 POC data */
#if defined(PISTORM_ANY_MODEL)
                tmp = RA_AllocARMRegister(ctx);
                u.u64 = (uintptr_t)&linux_poc_data;
                EMIT(ctx,
                    mov64_immed_u16(tmp, u.u16[3], 0),
                    movk64_immed_u16(tmp, u.u16[2], 1),
                    movk64_immed_u16(tmp, u.u16[1], 2),
